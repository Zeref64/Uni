...
int main (int argc, char **argv){
    ...
    // setter example
    std::cout << "setter για το s1, πεδίο AM:" << std::endl;
    (*s1).setAM("64646464");
    ...
    std::cout << "Η τιμή του semester για το αντικέιμενο s2 άλλαξε: " << (*s2).getSemester() << std::endl;

    //After using the setters the duplicate will take the new values.
    Student *duplicate1 = s1;   // Calls the copy constructor and makes a duplicate of s1 
    std::cout << "Αντίγραφο του s1:" <<std::endl;
