...
//? Linux one-liner για γρήγορη εκτέλεση στο level0:
//? clear && g++ -std=c++11 -Wall *.cpp -o game -lncursesw && ./game level0.txt
...
int main(int argc, char** argv) {
    ...
    std::string* gameStory = new std::string("Στο Μαγικό Εκπαιδευτικό Ίδρυμα (Μ.Ε.Ι.) Δυτικής Αττικής, "
